 ...
 *  1. Vouch button now toggles (Instagram-like): red heart when vouched, gray when not.
 *     Toggle persists in Supabase. One vouch per seller pair, with full unvouch support.
 *  2. Gold verification badge (is_verified) with Tooltip showing vouch count.
 *  3. Admin users see inline Block/Unblock on every product card.
 *  4. Edit Store mode unchanged.
 */
          ...
          <div className="mt-6 flex gap-2">
            {isOwner ? (
              ...
              <>
                ...
                {/* Vouch toggle button — Instagram style */}
                {canVouch && (
                  <Button
                    onClick={handleVouch}
