...
import {
  PRODUCT_SHARE_CARD_WIDTH,
  PRODUCT_SHARE_CARD_HEIGHT,
} from "@/lib/product-share-card/export";
  ...
  ({ product, vendor, className }, ref) => {
    ...
    return (
      ...
      >
        ...
        <div className="absolute inset-x-0 top-0" style={{ height: 760 }}>
          {image ? (
            ...
            <div
              ...
              style={{ backgroundColor: GLOW, color: ESPRESSO }}
            >
          ...
          <div
            className="absolute left-8 top-8 flex items-center gap-2 rounded-full px-4 py-2 shadow-lg"
            style={{ backgroundColor: "rgba(252,249,245,.92)" }}
          >
            <div
              className="grid h-7 w-7 place-items-center rounded-lg text-sm font-black"
              style={{ backgroundColor: ACCENT, color: CREAM }}
            >
              Z
            </div>
            <span className="text-base font-black tracking-tight" style={{ color: ESPRESSO }}>
              ZANGO
            </span>
          </div>
          ...
          <div
            className="absolute right-8 top-8 rounded-full px-5 py-2.5 text-xl font-bold shadow-lg"
            style={{ backgroundColor: ACCENT, color: CREAM }}
          >
        ...
        {/* Bottom info panel */}
        <div
          className="absolute inset-x-0 bottom-0 flex flex-col justify-center gap-4 px-10"
          style={{ height: 320 }}
        >
          <h1
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  <span className="text-lg font-semibold" style={{ color: ESPRESSO }}>
