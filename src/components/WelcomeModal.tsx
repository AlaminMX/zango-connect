...
export function WelcomeModal() {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-sm rounded-3xl bg-card border border-border/60 shadow-2xl p-7"
      ...
      >
        ...
        <div className="text-center mb-5">
          ...
          <p className="mt-1.5 text-sm text-muted-foreground">
            Kasuwancin Arewa — Northern Nigeria's community marketplace.
            <br />
        ...
        <div className="grid grid-cols-2 gap-3">
          {(
            [
              ["buyer", "I'm Shopping", "Browse & discover", ShoppingBag],
              ["seller", "I'm Selling", "Open your store", Store],
            ] as const
