...
export function humanizeError(error: unknown): string {
  ...
  if (lower.includes("not confirmed")) return "Please verify your email address before signing in.";
  ...
  // Validation errors
  if (lower.includes("required")) return "Please complete all required fields.";
  if (lower.includes("validation failed")) return "Please check your information and try again.";
