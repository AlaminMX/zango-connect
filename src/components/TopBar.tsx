    ...
    <header className="sticky top-0 z-40 w-full bg-background/85 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-3 px-5">
        <Link to="/" className="flex shrink-0 items-center gap-2.5">
          <img src="/sutura-logo.png" alt="Sutura Market" width={56} height={56} className="h-12 w-12 object-contain" />
          <div className="hidden flex-col leading-none sm:flex">
            <span className="font-display text-xl text-espresso">Sutura</span>
            <span className="text-[10px] font-semibold uppercase tracking-[0.22em] text-sage-deep">Arewa Market</span>
          </div>
        </Link>
