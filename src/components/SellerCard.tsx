  ...
  return (
    ...
    >
      <div className="flex items-start gap-3 p-4">
        <div
          className={`relative h-14 w-14 shrink-0 overflow-hidden rounded-full bg-surface-warm ring-2 ${s.is_verified ? "ring-sage" : "ring-border-warm"}`}
        >
          {s.profile_photo_url ? (
            <img
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-1.5">
            <h3 className="truncate font-display text-lg leading-tight text-espresso">
              {s.business_name}
            </h3>
